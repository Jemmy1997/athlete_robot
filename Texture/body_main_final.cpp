...
void timer1(int value)
{
	...
	{    
		if (shoulder2 < 90)
		{
			shoulder2 = (shoulder2 + 5) % 360;
			glutPostRedisplay();
			glutTimerFunc(l, timer1, 1);
		}
		else if  (rshoulder2 < 180)
		{
			rshoulder2 = (rshoulder2 + 5) % 360;
			glutPostRedisplay();
			glutTimerFunc(l, timer1, 1);
	...
	if (value == 2)
	{
		...
		else if (rshoulder2 > 0)
		{
			rshoulder2 = (rshoulder2 - 5) % 360;
			glutPostRedisplay();
			glutTimerFunc(1, timer1, 2);
		}
		else if (shoulder2 > 0)
		{
...
void timer(int val)
{
	...
	else if (val== 3)
	{
		...
		glutTimerFunc(0, timer1,state);
		glutTimerFunc(0, timer2, state);
		state=-2;
	}
